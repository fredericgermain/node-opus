...
var Encoder = function( rate, channels, frameSize, params ) {
...
Encoder.prototype._writeHeader = function() {
    ...
    var data = this.params.OpusHead || new Buffer([
        0x01,  // version
        this.channels,
    ...
    var vendor = new Buffer( this.params.vendor || 'node-opus', 'ascii' );
    ...
    header = new Buffer.concat(OpusTagsBuffers);
